...
export default class Timer extends React.Component{
    constructor(){
        ...
        this.state={
             isSession : true,
             timerSecond:0,
             intervalId:0    //to clear the interval
        };
        ...
        return(
            <section>
                <section  className="timer-container">
                    ...
                    <span className="timer">{this.state.timerSecond === 0 ? "00" : this.state.timerSecond < 10 ? "0" + this.state.timerSecond : this.state.timerSecond}
                    </span>
                </section>
